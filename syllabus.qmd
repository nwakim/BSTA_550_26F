...
::: blue-cont
- If an assignment on Brightspace is closed or you are submitting late work, **please email me and the TA your work** (see [instructor page](instructors.qmd) for all email addresses)
  - **It is important to email us both**
...
- **No attendance policy:** Your grade will not be linked to attending class, but you will be responsible for content covered
...
Mondays          10:30 AM -- 12:00 PM PST in room VPT 264

Wednesdays    10:30 AM -- 12:00 PM PST in room VPT 264
...
Students will use statistical software to complete homework assignments. Students are required to use R/RStudio for this course. R can be freely downloaded. [Helpful documentation](https://rstudio-education.github.io/hopr/starting.html) on installing R is available. **I encourage you to install R prior to attending our second lecture.** Please email me if you need help installing R or RStudio.
...
##### Additional R Resource

I teach a course, PUBH 523, that serves as an introduction to R. You can access the videos, practices, etc. [on the course site.](https://nwakim.github.io/PUBH_523_26F/)
...
| Lecture | In person | Twice, Weekly | Course content is provided through in-person lectures. Lectures will consist of didactic lessons and interactive examples. Sessions will be recorded and posted online. **Attending or viewing the lecture within 7 days of the original lecture date is mandatory.** Class attendance will be taken through an Exit Ticket. If viewing the lecture asynchronously, you must take the Exit Ticket to verify your attendance. |
...
| Project (Checkpoints and Final Brief) | Online | 4 checkpoints, 1 final brief | The project will be a combination of submitted checkpoints that will span the quarter and one final report submitted at the end of the quarter. This is meant to translate the tools learned in the course to the work one may do in the workforce. Checkpoints will guide you through the needed calculations and background for the project. The final brief will summarize your work over the quarter by giving context and results for your scenario. Students will work independently or in pairs on each checkpoint. |
...
| Homework | Formative | Every 1-2 weeks | 30% |
| Quizzes | Summative | `r q1_close %>% format("%m/%d")`, `r q2_close %>% format("%m/%d")`, `r q3_close %>% format("%m/%d")` | 24% |
| Project Checkpoints | Formative/Summative | Every 2-3 weeks | 25% |
| Project Final Brief | Summative | `r proj %>% format("%m/%d")` | 10% |
...
<tr>
<td style="text-align: center;"><p>Homework</p>
<p>assignment</p></td>
...
<li><p>Ask fellow students on Slack</p></li>
</ul></td>
<td style="text-align: left;"><ul>
<li><p>Discuss problems with your group</p></li>
<li><p>For answers that involve writing sentences, check with me or a TA if your answer is sufficient</p></li>
<li><p>Go to Office Hours to ask about your work</p></li>
</ul></td>
</tr>
<tr>
...
<td style="text-align: left;"><ul>
<li>Review muddiest and clearest points from the week</li>
</ul></td>
</tr>
</tbody>
</table>
...
[*Attend class*]{.underline}\*\*\*\* You are expected to attend at least 12 scheduled class meetings in-person. Attendance is taken through exit tickets. If you have issues accessing the poll on a specific day, please let me know. 

[\*Participate**\***]{.underline} I encourage you to participate actively in class and in Slack discussions. I will expect all students, and all instructors, to be respectful of each other's contributions, whether I agree with them or not. Professional interactions are expected.
...
[*Seek help if you need it*]{.underline}\*\*\*\* I believe it is important to support the physical and emotional well‐being of my students. If you are experiencing physical and/or mental health issues, I encourage you to use the resources on campus such as those listed below. If you have a health issue that is affecting your performance or participation in the course, and/or if you need help connecting with these resources, please contact me.
